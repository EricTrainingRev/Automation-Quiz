...
public class PageTwoFeatureFile {
    
    public PageTwoFeatureFile(WebDriver driver) {
    }


    @Given("Selenium has pulled up page two")
public void selenium_has_pulled_up_page_two() {
   TestRunner.driver.get("File://C:/Users/colem/OneDrive/Desktop/Automation-Quiz/quiz/src/test/resources/web-pages/PageTwo.html"); 
}
