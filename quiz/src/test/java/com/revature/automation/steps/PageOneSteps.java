package com.revature.automation.steps;

import org.openqa.selenium.support.ui.ExpectedConditions;

import com.revature.automation.runner.TestRunner;
...
public void selenium_has_pulled_up_page_one() {
    TestRunner.driver.get("File://C:/Users/aflem/OneDrive/Desktop/Automation-Quiz/quiz/src/test/resources/web-pages/PageOne.html");
}
...
public void selenium_takes_the_random_name_and_enters_it_in_the_input_element() {
    TestRunner.pageOne.get("randomString");
    TestRunner.pageOne.enterName("nameInput");
}
@When("Selenium clicks the submit button for page one")
public void selenium_clicks_the_submit_button_for_page_one() {
    TestRunner.pageOne.clickSubmitButton();
}
